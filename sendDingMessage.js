...
module.exports = {
    ...
    deploy9000: async (pwd) => {
      const cmd =`curl 'http://10.206.16.3:8090/job/build_9000_of_106/buildWithParameters?token=fc-frontend&srm_branch=pre&n9e_branch=main&n9e_plus_branch=pre' --user admin:${pwd}`
      shell.exec(cmd);
    }
};
